...
export const SOUND_ASSETS: readonly SoundAssetDefinition[] = [
  ...
  asset(SOUND_ASSET_IDS.ENEMY_SHOT, 'combat/enemy-shot.mp3', '敵射撃'),
...
export const SOUND_EVENTS: readonly SoundEventDefinition[] = [
  ...
  readyEvent(SOUND_KEYS.UI_MENU_UP, 'ui', 0.34, 'P0', SOUND_ASSET_IDS.UI_CURSOR, { cooldownMs: 35, polyphony: 2, detuneRange: 30, description: 'メニューカーソル上移動' }),
  readyEvent(SOUND_KEYS.UI_MENU_DOWN, 'ui', 0.34, 'P0', SOUND_ASSET_IDS.UI_CURSOR, { cooldownMs: 35, polyphony: 2, detuneRange: 30, description: 'メニューカーソル下移動' }),
  readyEvent(SOUND_KEYS.UI_MENU_LEFT, 'ui', 0.3, 'P0', SOUND_ASSET_IDS.UI_CURSOR, { cooldownMs: 35, polyphony: 2, detuneRange: 20, description: 'スライダー/選択肢左' }),
  readyEvent(SOUND_KEYS.UI_MENU_RIGHT, 'ui', 0.3, 'P0', SOUND_ASSET_IDS.UI_CURSOR, { cooldownMs: 35, polyphony: 2, detuneRange: 20, description: 'スライダー/選択肢右' }),
  readyEvent(SOUND_KEYS.UI_CONFIRM, 'ui', 0.44, 'P0', SOUND_ASSET_IDS.UI_CONFIRM, { cooldownMs: 60, polyphony: 3, description: '決定' }),
  readyEvent(SOUND_KEYS.UI_CANCEL, 'ui', 0.38, 'P0', SOUND_ASSET_IDS.UI_CANCEL, { cooldownMs: 60, polyphony: 3, description: '戻る/キャンセル' }),
  readyEvent(SOUND_KEYS.UI_OPEN, 'ui', 0.34, 'P0', SOUND_ASSET_IDS.UI_PANEL_OPEN, { cooldownMs: 80, polyphony: 2, description: 'UIを開く' }),
  readyEvent(SOUND_KEYS.UI_CLOSE, 'ui', 0.32, 'P0', SOUND_ASSET_IDS.UI_PANEL_CLOSE, { cooldownMs: 80, polyphony: 2, description: 'UIを閉じる' }),
  readyEvent(SOUND_KEYS.UI_ERROR, 'ui', 0.42, 'P0', SOUND_ASSET_IDS.UI_ERROR, { cooldownMs: 120, polyphony: 1, description: '選択不可/エラー' }),
  readyEvent(SOUND_KEYS.TITLE_NEW_GAME, 'ui', 0.6, 'P0', SOUND_ASSET_IDS.TITLE_NEW_GAME, { cooldownMs: 300, polyphony: 1, description: 'New Game 決定' }),
  readyEvent(SOUND_KEYS.TITLE_LOAD_GAME, 'ui', 0.56, 'P0', SOUND_ASSET_IDS.TITLE_LOAD_GAME, { cooldownMs: 300, polyphony: 1, description: 'Load Game 決定' }),
  ...
  readyEvent(SOUND_KEYS.COMBAT_PLAYER_HIT, 'sfx', 0.24, 'P0', SOUND_ASSET_IDS.PLAYER_HIT, { cooldownMs: 100, polyphony: 3, description: 'プレイヤー被弾' }),
  readyEvent(SOUND_KEYS.COMBAT_PLAYER_HIT_HEAVY, 'sfx', 0.22, 'P0', SOUND_ASSET_IDS.PLAYER_HIT_HEAVY, { cooldownMs: 100, polyphony: 3, description: 'プレイヤー被弾の別音色' }),
  ...
  readyEvent(SOUND_KEYS.COMBAT_ENEMY_SHOT, 'sfx', 0.08, 'P1', SOUND_ASSET_IDS.ENEMY_SHOT, { cooldownMs: 45, polyphony: 6, detuneRange: 35, description: '敵射撃' }),
  ...
  readyEvent(SOUND_KEYS.SYSTEM_SAVE_LOAD, 'ui', 0.46, 'P2', SOUND_ASSET_IDS.SYSTEM_SAVE_LOAD, { cooldownMs: 240, polyphony: 1, description: 'コンソール保存/ロード' }),
  ...
  readyEvent(SOUND_KEYS.EQUIPMENT_ARCHIVE_CATEGORY_SELECT, 'ui', 0.4, 'P2', SOUND_ASSET_IDS.EQUIPMENT_ARCHIVE_CATEGORY_SELECT, { cooldownMs: 80, polyphony: 2, description: '装備/アーカイブの分類選択' }),
  readyEvent(SOUND_KEYS.EQUIPMENT_ARCHIVE_DETAIL_SELECT, 'ui', 0.38, 'P2', SOUND_ASSET_IDS.EQUIPMENT_ARCHIVE_DETAIL_SELECT, { cooldownMs: 70, polyphony: 2, description: '装備/アーカイブの詳細選択' }),
