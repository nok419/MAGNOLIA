...
const NAV_CUE_COLORS: Record<NavCueKind, { rgb: string }> = {
  ...
  item:      { rgb: MG_CANVAS_PALETTE.quietWhite.rgb }, // ほんのり青白い白
  mission:   { rgb: MG_CANVAS_PALETTE.dangerNoise.rgb }, // ミッション反応は警告色として赤に寄せる
  warp:      { rgb: MG_CANVAS_PALETTE.memoryFragment.rgb }, // タン寄りの橙
}
