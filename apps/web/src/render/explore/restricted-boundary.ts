...
import { TAU, clampScalar, easeInOutSine, easeOutCubic, lerpScalar } from "@/render/explore/explore-render-utils"

export type BoundaryReleaseSequence = {
  progress: number
...
function drawBoundaryBeam(
  ...
  ctx.save()
  ctx.strokeStyle = rgba("signalReadable", 0.16 * beamAlpha)
  ctx.lineWidth = 18
  ctx.shadowColor = rgba("signalReadable", 0.3 * beamAlpha)
  ctx.shadowBlur = 28
  ctx.strokeRect(input.x, input.y, input.width, input.height)

  ctx.strokeStyle = rgba("signalReadable", 0.32 * beamAlpha)
  ctx.lineWidth = 9
  ctx.shadowBlur = 16
  ctx.strokeRect(input.x, input.y, input.width, input.height)

  ctx.strokeStyle = rgba("signalReadable", 0.75 * beamAlpha)
  ctx.lineWidth = 2.2
  ctx.shadowBlur = 8
  ctx.strokeRect(input.x, input.y, input.width, input.height)
...
function drawBoundaryFlux(
  ...
  ctx.save()
  ctx.strokeStyle = rgba("signalReadable", 0.42 * input.beamAlpha)
  ctx.lineWidth = 1.3
  ctx.shadowColor = rgba("signalReadable", 0.35 * input.beamAlpha)
  ctx.shadowBlur = 10
...
function drawBoundaryReleaseShockwave(
  ...
  ctx.save()
  ctx.strokeStyle = rgba("signalReadable", (0.36 * residualAlpha))
  ctx.lineWidth = 2.1
  ctx.shadowColor = rgba("signalReadable", (0.42 * residualAlpha))
  ctx.shadowBlur = 16
  ctx.beginPath()
  ctx.arc(input.x, input.y, primaryRadius, 0, TAU)
  ctx.stroke()

  ctx.strokeStyle = rgba("signalReadable", (0.16 * residualAlpha))
  ctx.lineWidth = 1
  ctx.beginPath()
  ...
  for (let index = 0; index < 10; index += 1) {
    ...
    ctx.strokeStyle = rgba("signalReadable", (0.18 * residualAlpha))
    ctx.lineWidth = 0.9
    ctx.beginPath()
    ctx.moveTo(
...
function drawBoundaryPerimeterDissolve(
  ...
  for (let index = 0; index < segmentCount; index += 1) {
    ...
    ctx.strokeStyle = rgba("signalReadable", (0.76 * residualAlpha * intactFactor))
    ctx.lineWidth = 2.6
    ctx.shadowColor = rgba("signalReadable", (0.42 * residualAlpha * intactFactor))
    ctx.shadowBlur = 10
...
function drawBoundaryReleaseStrand(
  ...
  ctx.save()
  ctx.strokeStyle = rgba("signalReadable", (input.alpha * shimmer))
  ctx.lineWidth = 1.35
  ctx.shadowColor = rgba("signalReadable", (input.alpha * 0.9))
  ctx.shadowBlur = 10
  ctx.beginPath()
