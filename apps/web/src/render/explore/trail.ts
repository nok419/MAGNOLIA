...
import { TAU, lerpScalar, seededUnit } from "@/render/shared/canvas-math"
...
export function createExploreTrailState(): ExploreTrailState {
  return {
    prevPlayerX: 0,
    prevPlayerY: 0,
    initialized: false,
...
function drawLightMotes(
  ...
  if (state.motes.length === 0) return
