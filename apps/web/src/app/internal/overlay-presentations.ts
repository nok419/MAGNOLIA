...
export function mergeOverlayPresentations<T extends OverlayQueueState>(
  current: T,
  nextRequests: OverlayPresentationRequest[],
): Pick<OverlayQueueState, "activeOverlayPresentation" | "pendingOverlayPresentations"> {
...
export function transitionRebootToSettle<T extends OverlayQueueState>(
  ...
  return {
    ...
    // pending は reboot 本編と同じ順序で維持。settle は本編の延長として active を差し替えます。
    pendingOverlayPresentations: current.pendingOverlayPresentations,
  }
}
